...
public class AdminController {
	...
	public String list(PageInfo pageInfo, Model model) {
		...
		// imgList List[ List[ReviewImgVO, ReviewImgVO] ,List[ReviewImgVO] , List
		// [ReviewImgVO] ,......... ]
	...
	// 리뷰 삭제
	@PostMapping("delete")
	public String delete(@RequestParam("selectedReviews") List<Long> selectedReviews, PageInfo pageInfo) {
		
		//관리자 체크 박스 클릭한것만 삭제 가능
		for (Long reviewnum : selectedReviews) {
			// 리뷰 삭제
