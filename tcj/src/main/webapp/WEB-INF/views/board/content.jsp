	...
	<table border="1">
		...
		<tr>
			<td colspan="2">
				...
				<input type="button" value="리스트" onclick="window.location='/board/list?pageNum=${pageInfo.pageNum}&listSize=${pageInfo.listSize}&sel=${pageInfo.sel}&keyword=${pageInfo.keyword}'" />
			</td>
		</tr>
	</table>
	<br /><br />
